...
public class BookMeetingRoom {
	...
	void bookMeetingRoom(){
		if(nalandaFlag==false){
			...
			System.out.println("-->The meeting room Nalanda is already booked.");
		}
	}
	void bookMeetingRoom(String meetingRoom){
		if(meetingRoom!="Nalanda"){
			if(meetingRoom=="Takshashila"&&takshashilaFlag==false){
				this.meetingRoom="Takshashila";
				hours=1;
				displayInfo();
				takshashilaFlag=true;
			}
			else if(meetingRoom=="AgraFort" &&agraFortFlag==false){
				this.meetingRoom="AgraFort";
				hours=1;
				displayInfo();
				agraFortFlag=true;
			}
			else if(meetingRoom=="PratapGadh"&&pratapGadhFlag==false){
				...
				System.out.println(meetingRoom +"-->The meeting room Nalanda is already booked.");
			}
		}
		else{
			System.out.println(meetingRoom +"-->The meeting room Nalanda is already booked.");
