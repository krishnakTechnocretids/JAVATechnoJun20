...
public class CharOps {
	...
	public static void main(String[] args){
		...
		System.out.print("**Do you want to check the logic: to search the frequency of each character in a predefined name? (y/n)");
		String tmp1= scanner.next();
		if (tmp1.equals("y")){
			System.out.println("The name is: aakanksha");
			charOps.AllCharFreq("aakanksha");
		}
		System.out.print("**Do you want to check the logic: to search the frequency of each character in each name of a pre-defined aray? (y/n)");
		String tmp2= scanner.next(); 
			if (tmp2.equals("y")){
				System.out.println(" Array: raj, aarya, aavruti, shruti");
				charOps.AllCharFreqArray(arr);
			}	
		scanner.close();		
	}
