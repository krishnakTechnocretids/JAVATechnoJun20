...
public class IntersectionOfArrays {
	...
	// Method to get the Intersection values from the Unique Arrays
	...
	// Method to get Unique Numbers from the Array
	...
	public static void main(String[] agrs) {
		...
		new IntersectionOfArrays().getIntersectionOfArray(arr1, arr2);
	}
}
