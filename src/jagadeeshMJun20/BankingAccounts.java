	...
	boolean message() {
		if (crdCount > debCount)
			...
			public static void main (String[] agrs){
				BankingAccounts bankingAccounts = new BankingAccounts();
				bankingAccounts.bankOperation("BOB", 1000, "Credit");
				bankingAccounts.bankOperation("ICICI", 1500.5, "Credit");
				bankingAccounts.bankOperation("SBI", 1500.5, "Debit");
				bankingAccounts.bankOperation("BOB", 5000, "Debit");
				bankingAccounts.bankOperation("BOB", 10000, "Credit");
				bankingAccounts.totalBankBalance();
				bankingAccounts.totalOperations();
				bankingAccounts.invCreditOperations();
				bankingAccounts.invDebitOperations();
				if (bankingAccounts.message() == true)
