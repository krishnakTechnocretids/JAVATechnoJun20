...
public class SecondLastStringReplace {
	...
	private void getSecondLastString(String input, String wordToReplace) {
		if (input.contains("Globant")) {
			...
			System.out.println(
					"Output: " + newInp.substring(0, secondLastIndex) + outputString + input.substring(lastIndex));
		} else {
			System.out.println("The word \"" + wordToReplace + "\" is not available in String .");
		}
	}
	...
	public static void main(String[] args) {
		...
		secondLast.getSecondLastString(input, "Globant");
	}
}
